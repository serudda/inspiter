 ...
 <div class="menuMain wrapper-pri conf">
     <div class="CropFase">
         <ul class="menuFasesItems">
             <li>
                 <button class="btn btn-success btnConfig btnEdition" id="btn_crop_phraseGraph" disabled="disabled"><?php echo frasesgraficas03; ?></button>
             </li>
             <li style="margin-left: 0px;">
                 <p id="titleWelcomePage" class="titleWelcomePage fontBeforeCenter"><?php echo frasesgraficas04; ?></p>
             </li>
         </ul>
     </div>
     <div class="EditionFase">
         <ul class="menuFasesItems">
             <li>
                 <a id="phraseGraphShareToFacebook" class="facebook-share-button external-share-button" href="#" data-checked="unchecked" title="Compartir en Facebook">Facebook</a>
             </li>
             <li>
                 <button class="btn btn-success btnConfig btnEdition" id="btn_save_phraseGraph"><?php echo frasesgraficas05; ?></button>
             </li>
             <li>
                 <div id="button-changeImage-phraseGraph" class="btn-phraseGraph button-browser-image"><?php echo frasesgraficas06; ?></div>
                 <!--<button id="btn_change_image" class="btn btn-cancel-option btn_cancel_config">Cambiar Imagen</button>-->
             </li>
             <li>
                 <div id="button-returnCrop-phraseGraph" class="btn-phraseGraph button-browser-image"><?php echo frasesgraficas07; ?></div>
                 <!--<button id="btn_return_crop" class="btn btn-cancel-option btn_cancel_config">Volver a Cortar</button>-->
             </li>
             <li>
                 <p id="titleEditorPage" class="titleWelcomePage fontBefore"><?php echo frasesgraficas08; ?></p>
             </li>
         </ul>
        
     </div>
     <div class="BadgeBeta" style=" background-image: url('../images/iconsIns.png');background-position:-76px -300px;height:64px;left:-5px;position:absolute;top:-5px;width:64px;"></div>
 </div>
...
=============================================--> 
 <div class="BodyPage wrapper-pri conf"> 
     <div class="OptionsBlockPos">
         <h3><?php echo frasesgraficas09; ?> 
             <div id="buttonChangeTextEdit"><b id="textOptionSelected"><?php echo frasesgraficas10; ?></b>
                 <span class="icoBlock">
        ...
        <div class="OptionBlock">
            <div class="FamilyFontBlock">
                <div class="FamilyFontBlockTitle"><?php echo frasesgraficas12; ?></div>
                <div class="ListOption">
                    <ul>
                        <li class="Arial fontPhraseGraph" data-font="Arial" data-text="Arial" data-line="0" data-hasitalic="yes" data-phselected="none" data-auselected="none">Arial</li>
                        <li class="Asombro fontPhraseGraph" data-font="Asombro" data-text="Asombro" data-line="0" data-hasitalic="none" style="font-size:2em;" data-phselected="none" data-auselected="none">Asombro</li>
                        <li class="Calibri fontPhraseGraph" data-font="Calibri" data-text="Calibri" data-line="0" data-hasitalic="yes" data-phselected="none" data-auselected="none">Calibri</li>
                        <li class="CourierNew fontPhraseGraph" data-font="Courier" data-text="Courier New" data-line="0" data-hasitalic="yes" data-phselected="none" data-auselected="none">Courier New</li>
                        <li class="ComicSans fontPhraseGraph" data-font='"ComicSansMS",cursive,sans-serif' data-line="0" data-hasitalic="none" data-text="Comic Sans MS" data-phselected="none" data-auselected="none">Comic Sans</li>
                        <li class="HandSean fontPhraseGraph" data-font='HandSean' data-text="HandSean" data-line="0" data-hasitalic="none" data-phselected="none" data-auselected="none">HandSean</li>
                        <li class="Impact fontPhraseGraph" data-font="Impact" data-text="Impact" data-line="0" data-hasitalic="none" data-phselected="none" data-auselected="none">Impact</li>
                        <li class="JennaSue fontPhraseGraph" data-font="JennaSue" data-text="JennaSue" data-line="0" data-hasitalic="none" style="font-size:2.5em;" data-phselected="none" data-auselected="none">Jenna Sue</li>
                        <li class="Jellyka fontPhraseGraph" data-font="Jellyka" data-text="Jellyka" data-line="12" data-hasitalic="none" style="font-size:5em;" data-phselected="none" data-auselected="none">Jellyka</li>
                        <li class="LucidaSans fontPhraseGraph" data-font='"LucidaGrande", "LucidaSansUnicode", "LucidaSans", Geneva, Verdana, sans-serif' data-line="0" data-hasitalic="yes" data-text="Lucida Sans" data-phselected="none" data-auselected="none">Lucida Sans</li>
                        <li class="Motion fontPhraseGraph" data-font='Motion' data-text="Motion" data-line="0" data-hasitalic="none" style="font-size:2.3em;" data-phselected="none" data-auselected="none">Motion</li>
                        <li class="PassingNotes fontPhraseGraph" data-font='PassingNotes' data-text="PassingNotes" data-line="0" data-hasitalic="none" data-phselected="none" data-auselected="none">Passing Notes</li>
                        <li class="TimesNewRoman fontPhraseGraph" data-font='TimesNewRoman, "TimesNewRoman", Times, Baskerville, Georgia, serif' data-text="Times New Roman" data-line="0" data-hasitalic="yes" data-phselected="none" data-auselected="none">Times New Roman</li>
                    </ul>
                </div>
            </div>
            <div class="StyleFontBlock FamilyFontBlockTitle">
                <ul class="optionPanelText">
                    <li class="font_text_phrase size">
                        <a href="#" id="font-size-text" data-sizephrase="45" data-sizeauthor="30" data-line="12" title="Aumentar tamaño de la letra" style="padding:4px 4px 4px 8px;">
				A
				<div class="ico-more-font moreSize"></div>
                    ...
                    <li class="font_text_phrase size">
			 <a href="#" id="font-size-text-less" data-sizephrase="45" data-sizeauthor="30" data-line="12" title="Reducir tamaño de la letra" style="padding:4px 4px 4px 8px;">
				A
			 ...
			 <a href="#" id="font-bold-text" title="Agregarle Negrita al texto">B</a>
                    ...
                    <li class="font_text_phrase italic">
                         <div id="tooltipDontItalic" class="tooltipDontItalic tooltip top">
                             <div class="tooltip-arrow arrowCustom"></div>
                             <div class="icoAlert"></div>
                             <span><?php echo frasesgraficas13; ?></span>
                         </div>
			 <a href="#" id="font-italic-text" data-hasitalic="yes" data-hasitalicauthor="yes" title="Hacer cursivo el texto">I</a>
                    </li>
			 ...
			 <a href="#" id="font-textalign-text" class="textalignstyle" title="Alinear el texto">
                             <div class="ico-more-font"></div>
				<dl class="list-option-phraseIn list-option-textalign" id="list-option-textalign">
				 ...
				 <dd class="option-text textalignright" data-textalign="right"></dd>
                    ...
                    <li class="sepLine"></li>
                    <li class="font_text_phrase TextAlign">
                        <a href="#" id="font-colorpicker-text" title="Cambiar color al texto">   
...
<!--        <div class="OptionBlock OptionExtra">
	 ...
	 <p class="autor-name" id="textPhraseAuthorGraph" style="cursor:move; position:absolute!important;z-index: 3;color:#FFF;font-family: Arial;font-size: 30px;left: 228px;text-align: right;top: 396px;" data-bold="normal" data-italic="normal" data-shadow="none" data-typefont="Arial"></p>
         ...
         <img  id="ImageShadowGraph" class="ImagePhraseIn" src="/images/footerPhraseGraph.jpg" style="z-index: 1;opacity: 0.9;bottom:0px;">
     </div>
     ...
     <div class="ImageBeforeBlock">   
         ...
         <div class="browse-image-phraseGraph">
             <div class="posInputBrowser">
                <input type="text" placeholder="<?php echo pegaURLBrowse; ?>" name="FileUploadBrowserPhraseGraph" class="FileUploadBrowser" id="FileUploadBrowserPhraseGraph">
             </div>
             <div class="posButtonBrowser">
                <div class="button-browser-image" id="button-add-image-phraseGraph" style="display: none;"><?php echo agregarImage; ?></div>
     ...
     <div class="PosTextArea">
        <textarea id="inputPhraseGraph" name="inputPhraseGraph" placeholder="<?php echo canPublish; ?>" class="textareaAbout phraseTextGraph" name="comment_text" style="margin-bottom: 0px!important;"></textarea>
     </div>
     <div id="NotePhraseGraph" class="PosNoteInfo NotePhraseGraph">
         ...
         <strong><?php echo frasesgraficas15; ?></strong><?php echo frasesgraficas16; ?><a href="/contactenos.php" style="font-weight: bold;"><?php echo frasesgraficas17; ?></a>. 
     </div>
     <div class="PosAuthorPhraseIn"  style="margin-left: 654px; display: none;">
      <textarea id="inputAuthorGraph" name="inputAuthorGraph" placeholder="<?php echo autorFrase; ?>" class="inputAuthorGraph textareaAbout phraseIn authorIn" name="author_text"></textarea>
     </div>
...
<input type="hidden" id="ImagePhraseURL" />
    ...
    <div id="ModalIns" class="styled">
		 ...
		 <div class="header-modal grd">
			<a id="closeModalIns" class="close" href="#"><strong><?php echo close; ?></strong><span></span></a>
			<h2><?php echo inspirate; ?></h2>
                                                                                                </div>
